 ...
 * <p>
 * This consumer listens to a test topic and logs received messages,
 * providing concrete evidence that the AMQP messaging is working end-to-end.
 * </p>
 * <p>
 * Note: This is primarily for testing. In production, you would have
 * dedicated consumers for specific business logic.
 * </p>
 */
@ApplicationScoped
public class TestMessageConsumer {
    ...
    /**
     * Consumes messages from the test-topic for verification.
     * This proves that messages are successfully reaching the broker.
     */
